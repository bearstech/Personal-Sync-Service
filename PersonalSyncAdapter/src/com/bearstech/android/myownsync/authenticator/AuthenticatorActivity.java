...
package com.bearstech.android.myownsync.authenticator;
...
import com.bearstech.android.myownsync.client.NetworkUtilities;
...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mServerAddressEdit = (EditText) findViewById(R.id.serveraddress_edit);
    ...
    public void handleLogin(View view) {
        ...
        mServerAddress = mServerAddressEdit.getText().toString();
        if (TextUtils.isEmpty(mUsername) || TextUtils.isEmpty(mPassword) 
            ...
            mAuthThread =
                NetworkUtilities.attemptAuth(mUsername, mPassword, mServerAddress, mHandler,
    ...
    protected void finishLogin() {
        ...
        NetworkUtilities.setBaseURL(mServerAddress);
    ...
    private CharSequence getMessage() {
        ...
        if (TextUtils.isEmpty(mServerAddress)) {
        	return getText(R.string.login_activity_loginfail_text_serverunreachable);
        }
        return null;
    }
